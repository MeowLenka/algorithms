...
int main()
{
    ...
    wchar_t cw = L'Ф'; // = -135871592 L'\xf7e6c398' (до инициализации), потом = 1060 L'Ф'
    size_t n = sizeof(cw); //  = 140737350693775 (до инициализации), потом = 4
    ...
    double dDouble1 = iInt / 3;     // (1) = 6.9533558073650491e-310 (до инициализации), 
    // потом = 0 (int / int)
    double dDouble2 = iInt / 3.;    // (2) = 6.9533558073650491e-310 (до инициализации), 
