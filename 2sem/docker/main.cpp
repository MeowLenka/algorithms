...
void print_cat(const char *text)
{
    const char STOP_STRING = '\0';
    int count_prev = 0, count_symbol = 0, count_total = 0;
    bool flag = true;
    const int STOP = 40;
...
int main()
{
    char *text = "Looooong message, extra task for automatic weapon";
    print_cat(text);
    return 0;
}